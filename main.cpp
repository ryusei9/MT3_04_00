...
const char kWindowTitle[] = "LE2B_13_サトウ_リュウセイ_MT3_04_00";
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		ImGui::Text("ball.translation", &ball.position.x,0.01f);
		ImGui::Checkbox("start",&isSpringStart);
		...
		DrawHook(spring, ball, worldViewProjectionMatrix, viewPortMatrix);
		///
		/// ↑描画処理ここまで
		///
